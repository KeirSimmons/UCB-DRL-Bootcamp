...
def point_get_grad_logp_action(theta, ob, action):
    ...
    """
    # so we have 4 (# of actions) gaussian distributions over action spaces
    # adjusting theta will adjust the mean of the gaussian to choose better actions within the continuous space
    ob_1 = include_bias(ob)
